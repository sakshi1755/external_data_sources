#!/usr/bin/env python3
"""
Load NVS NCST clean data from GCS into BigQuery.

Reads:
    gs://avantifellows-external-data/nvs/clean/nvs_fact_ncst_results.parquet

Writes (WRITE_TRUNCATE):
    avantifellows.external_data_sources.nvs_fact_ncst_results
